...
const userInfo: any = ref(data);
const calcDate = (birthday: string) => {
  let birthdayDate: any = new Date(birthday);
  let todyDate: any = new Date();
  ...
  <div class="main-container">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-3 flex">
                  <a class="item wow inShow" data-wow-delay="0.55s">
                    <h4>经验</h4>
                    <div class="info">{{calcDate(userInfo.workSince)}}年</div>
                  </a>
                </div>
              </div>
              <div class="row">
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="section-content">
          <div class="intro">
            <p>{{calcDate(userInfo.workSince)}}年的一线城市前端研发经验。了解主流框架的一些特性。  </p>
